...
def sizing_function(x):
    ...
    for pair in var_pairs:
        val += pair[0]*pow(e, -pow(x-pair[1], 2.0)/(2*pow(pair[2], 2.0)))
...
class Page(object):
    ...
    def render(self):
        ...
        rendered_page += footer_row.render()
